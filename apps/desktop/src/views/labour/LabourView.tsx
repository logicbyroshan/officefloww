...
const INITIAL_LABOUR: LabourContractor[] = [
  ...
  },
  {
    ...
    email: "shyam.screen@adharshbhopal.in",
    workstation: "Screen Table 04",
    activeTask: "Order #ord-8: 600 Screen printed navy lanyards (Maulana Azad)",
    status: "ACTIVE",
    pieceRate: 2.1,
    lanyardsGiven: 600,
    assembledReturned: 0,
    ...
    amountDue: 1260.0,
    batches: [
      { batchNumber: "Batch #SP-09", clientName: "Maulana Azad Hospital", quantityGiven: 600, quantityReturned: 0, status: "IN_PROGRESS" },
    ],
  },
  {
    id: "lab-5",
